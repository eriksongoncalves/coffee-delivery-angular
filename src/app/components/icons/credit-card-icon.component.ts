  ...
  template: `
    ...
    >
      ...
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M2 12.1125C2 11.5603 2.44772 11.1125 3 11.1125H29C29.5523 11.1125 30 11.5603 30 12.1125C30 12.6648 29.5523 13.1125 29 13.1125H3C2.44772 13.1125 2 12.6648 2 12.1125Z"
        fill="currentColor"
      />
    </svg>
  `,
